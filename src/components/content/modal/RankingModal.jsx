        ...
        <ContentContainer>
            ...
            {topRanks.map((item) => (
              <RankItem key={item.rank}>
                ...
                <Box>
                  ...
                  <Typography variant="body2">{item.amount.toLocaleString()}원</Typography>
                </Box>
              </RankItem>
            ))}
          </List>
          {showUserRank && (
            <RankItem>
              ...
              <Box>
                <Typography variant="subtitle1">{rankingData[userRank - 1].nickname} (나)</Typography>
                <Typography variant="body2">{rankingData[userRank - 1].amount.toLocaleString()}원</Typography>
              </Box>
            </RankItem>
          )}
          <Button 
            variant="contained" 
            onClick={onClose} 
            style={{ marginTop: 16, backgroundColor: 'rgba(0, 0, 128, 0.8)', color: 'white' }}
          >
            닫기
          </Button>
        </ContentContainer>
